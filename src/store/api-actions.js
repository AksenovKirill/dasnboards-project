...
export const checkAuthAction = createAsyncThunk("/requireAuthorization", async (_, { rejectWithValue, dispatch }) => {
  try {
...
export const loginAction = createAsyncThunk("/login", async (userData, { rejectWithValue, dispatch }) => {
  try {
...
export const registrationAction = createAsyncThunk("/registration", async (userData, { rejectWithValue, dispatch }) => {
  try {
...
export const refreshTokenAction = createAsyncThunk("/refresh", async (token, { rejectWithValue, dispatch }) => {
  try {
...
export const logoutAction = createAsyncThunk("/logout", async (status, { rejectWithValue, dispatch }) => {
  await api.delete(API_LINKS.logOut);
  dropToken();
  dispatch(requireAuthorization({ status }));
});

export const loadWareHouseAction = createAsyncThunk("/loadWarehouse", async (_, { rejectWithValue, dispatch }) => {
...
export const loadOrganizationsAction = createAsyncThunk("/loadOrganizations", async (_, { rejectWithValue, dispatch }) => {
...
export const clearErrorAction = createAsyncThunk("/clearError", (_, { rejectWithValue, dispatch }) => {
  dispatch(setError(undefined));
});
export const clearSuccessAction = createAsyncThunk("/clearError", (_, { rejectWithValue, dispatch }) => {
