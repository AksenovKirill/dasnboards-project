            ...
            for (
              ...
              if (!(S instanceof r)) {
                var A,
                  x = 1;
                if (y) {
                  if (!(A = i(w, P, e, b)) || A.index >= e.length) break;
                  var _ = A.index,
                    $ = A.index + A[0].length,
                    E = P;
                  for (E += F.value.length; _ >= E; )
                    E += (F = F.next).value.length;
                  if (((P = E -= F.value.length), F.value instanceof r))
                    continue;
                  for (
                    var T = F;
                    T !== t.tail && (E < $ || "string" == typeof T.value);
                    T = T.next
                  )
                    x++, (E += T.value.length);
                  x--, (S = e.slice(P, E)), (A.index -= P);
                } else if (!(A = i(w, 0, S, b))) continue;
                _ = A.index;
                var O = A[0],
                  z = S.slice(0, _),
                  I = S.slice(_ + O.length),
                  N = P + S.length;
      ...
      Prism.hooks.add("before-highlightall", function (e) {
                  ...
                  (n.onreadystatechange = function () {
                    4 == n.readyState &&
                      (n.status < 400 && n.responseText
                        ...
                        : a("✖ Errors: File does not exist or is empty"));
                  }),
                  n.send(null);
              })(
                l,
                  ...
                  if (a) {
                    ...
                    r < 0 && (r += s.length),
                      ...
                      i.hasAttribute("data-start") ||
                        i.setAttribute("data-start", String(r + 1));
                  }
        ...
        (Prism.plugins.fileHighlight = {
          highlight: function (e) {
            for (
              var t, a = (e || document).querySelectorAll(s), n = 0;
              (t = a[n++]);
        ...
        value: function (a, n, s, r) {
          if (a.language === n) {
            ...
            (a.code = a.code.replace(s, function (e) {
              ...
              for (var s, o = i.length; -1 !== a.code.indexOf((s = t(n, o))); )
                ++o;
              return (i[o] = e), s;
            })),
        ...
        Prism.hooks.add("before-sanity-check", function (e) {
          ...
          if (
            ...
            if ((e.element && e.element.parentNode) || !e.code) {
              ...
              if (e.code && a && "pre" === a.nodeName.toLowerCase()) {
                for (
                  var n = a.childNodes, s = "", r = "", i = !1, o = 0;
                  o < n.length;
                  ++o
                ) {
                  var l = n[o];
